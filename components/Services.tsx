  ...
  return (
    <section id="services" className="relative overflow-hidden">
      <Stipple
        ...
        className="pointer-events-none absolute right-8 top-8 hidden h-24 w-32 opacity-[0.35] sm:block"
      />
      <div className="pointer-events-none absolute left-2 bottom-10 h-14 w-14 rounded-full bg-blush/50" />
          ...
          {SERVICES.map((service, i) => (
            <div key={service.title} className="contents">
              <div className="relative z-10 flex justify-center pt-1">
                <div className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-moss bg-paper font-serif text-sm italic text-moss sm:h-11 sm:w-11">
